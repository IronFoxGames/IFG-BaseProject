(function (scope) {
    ...
    !(function (r) {
        ...
        for (var n = CryptoJS, t = (a = n.lib).WordArray, i = a.Hasher, a = n.algo, s = [], f = [], o = 2, d = 0; d < 64; ) {
            ...
            l && (d < 8 && (s[d] = e(r.pow(o, 0.5))), (f[d] = e(r.pow(o, 1 / 3))), d++), o++;
        }
        var m = [];
        a = a.SHA256 = i.extend({
            _doReset: function () {
            ...
            _doProcessBlock: function (e, n) {
                for (
                    var t = this._hash.words, i = t[0], r = t[1], a = t[2], s = t[3], o = t[4], d = t[5], l = t[6], u = t[7], c = 0;
                    c < 64;
                    c++
                ) {
                    if (c < 16) m[c] = 0 | e[n + c];
                    ...
                    (v =
                        u + (((o << 26) | (o >>> 6)) ^ ((o << 21) | (o >>> 11)) ^ ((o << 7) | (o >>> 25))) + ((o & d) ^ (~o & l)) + f[c] + m[c]),
        ...
        (function () {
            ...
            CryptoJS.algo.HMAC = CryptoJS.lib.Base.extend({
                init: function (e, n) {
                    ...
                    for (var r = (this._oKey = n.clone()), a = (this._iKey = n.clone()), s = r.words, o = a.words, d = 0; d < t; d++)
                        (s[d] ^= 1549556828), (o[d] ^= 909522486);
        ...
        (function (e) {
            ...
            ((n = e.EGAErrorSeverity || (e.EGAErrorSeverity = {}))[(n.Undefined = 0)] = 'Undefined'),
                ...
                ((a = e.EGAAdError || (e.EGAAdError = {}))[(a.Undefined = 0)] = 'Undefined'),
                (a[(a.Unknown = 1)] = 'Unknown'),
                (a[(a.Offline = 2)] = 'Offline'),
                (a[(a.NoFill = 3)] = 'NoFill'),
                (a[(a.InternalError = 4)] = 'InternalError'),
                (a[(a.InvalidRequest = 5)] = 'InvalidRequest'),
                (a[(a.UnableToPrecache = 6)] = 'UnableToPrecache'),
                ((s = e.EGAAdType || (e.EGAAdType = {}))[(s.Undefined = 0)] = 'Undefined'),
                (s[(s.Video = 1)] = 'Video'),
                (s[(s.RewardedVideo = 2)] = 'RewardedVideo'),
                (s[(s.Playable = 3)] = 'Playable'),
                (s[(s.Interstitial = 4)] = 'Interstitial'),
                (s[(s.OfferWall = 5)] = 'OfferWall'),
                (s[(s.Banner = 6)] = 'Banner'),
                (o = e.http || (e.http = {})),
                ...
                (l = e.events || (e.events = {})),
                ((u = l.EGASdkErrorCategory || (l.EGASdkErrorCategory = {}))[(u.Undefined = 0)] = 'Undefined'),
                (u[(u.EventValidation = 1)] = 'EventValidation'),
                (u[(u.Database = 2)] = 'Database'),
                (u[(u.Init = 3)] = 'Init'),
                (u[(u.Http = 4)] = 'Http'),
                (u[(u.Json = 5)] = 'Json'),
                ((c = l.EGASdkErrorArea || (l.EGASdkErrorArea = {}))[(c.Undefined = 0)] = 'Undefined'),
                ...
                ((v = l.EGASdkErrorAction || (l.EGASdkErrorAction = {}))[(v.Undefined = 0)] = 'Undefined'),
                ...
                ((g = l.EGASdkErrorParameter || (l.EGASdkErrorParameter = {}))[(g.Undefined = 0)] = 'Undefined'),
        ...
        (function (e) {
            ...
            (n = e.utilities || (e.utilities = {})),
                (l = e.logging.GALogger),
                (u.getHmac = function (e, n) {
                ...
                (u.encode64 = function (e) {
                    e = encodeURI(e);
                    for (
                        var n, t, i, r, a, s = '', o = 0, d = 0, l = 0;
                        (i = (n = e.charCodeAt(l++)) >> 2),
                            (r = ((3 & n) << 4) | ((t = e.charCodeAt(l++)) >> 4)),
                            (a = ((15 & t) << 2) | ((o = e.charCodeAt(l++)) >> 6)),
                            (d = 63 & o),
                            isNaN(t) ? (a = d = 64) : isNaN(o) && (d = 64),
                            (s = s + u.keyStr.charAt(i) + u.keyStr.charAt(r) + u.keyStr.charAt(a) + u.keyStr.charAt(d)),
                            (n = t = o = 0),
                            (i = r = a = d = 0),
                            l < e.length;
                ...
                (u.decode64 = function (e) {
                    ...
                    for (
                        ...
                        (n = (u.keyStr.indexOf(e.charAt(d++)) << 2) | ((i = u.keyStr.indexOf(e.charAt(d++))) >> 4)),
                            (t = ((15 & i) << 4) | ((r = u.keyStr.indexOf(e.charAt(d++))) >> 2)),
                            (s = ((3 & r) << 6) | (o = u.keyStr.indexOf(e.charAt(d++)))),
                            (a += String.fromCharCode(n)),
                            64 != r && (a += String.fromCharCode(t)),
                            64 != o && (a += String.fromCharCode(s)),
                            (n = t = s = 0),
                            (i = r = o = 0),
                            d < e.length;
                ...
                var n =
                    ((f.validateBusinessEvent = function (e, n, t, i, r) {
                        return f.validateCurrency(e)
                            ? n < 0
                                ? (d.w('Validation fail - business event - amount. Cannot be less than 0. Failed amount: ' + n),
                                  new g(l.EventValidation, u.BusinessEvent, c.InvalidAmount, v.Amount, n + ''))
                                          ...
                                          ? f.validateEventPartLength(r, !1)
                                              ? f.validateEventPartCharacters(r)
                                                  ...
                                                  : (d.w(
                                                    ...
                                                    new g(l.EventValidation, u.BusinessEvent, c.InvalidEventPartCharacters, v.ItemId, r))
                                              : (d.w(
                                                    'Validation fail - business event - itemId. Cannot be (null), empty or above 64 characters. String: ' +
                                                        r
                                                ),
                                                new g(l.EventValidation, u.BusinessEvent, c.InvalidEventPartLength, v.ItemId, r))
                                          : (d.w(
                                                'Validation fail - business event - itemType: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: ' +
                                                    i
                                            ),
                                            new g(l.EventValidation, u.BusinessEvent, c.InvalidEventPartCharacters, v.ItemType, i))
                                      : (d.w(
                                            'Validation fail - business event - itemType: Cannot be (null), empty or above 64 characters. String: ' +
                                                i
                                        ),
                                        new g(l.EventValidation, u.BusinessEvent, c.InvalidEventPartLength, v.ItemType, i))
                                  : (d.w('Validation fail - business event - cartType. Cannot be above 32 length. String: ' + t),
                                    new g(l.EventValidation, u.BusinessEvent, c.InvalidShortString, v.CartType, t))
                            : (d.w(
                              ...
                              new g(l.EventValidation, u.BusinessEvent, c.InvalidCurrency, v.Currency, e));
                    }),
                    (f.validateResourceEvent = function (e, n, t, i, r, a, s) {
                        return e == m.EGAResourceFlowType.Undefined
                            ? (d.w('Validation fail - resource event - flowType: Invalid flow type.'),
                              new g(l.EventValidation, u.ResourceEvent, c.InvalidFlowType, v.FlowType, ''))
                            : n
                              ? o.stringArrayContainsString(a, n)
                                  ? 0 < t
                                      ? i
                                          ? f.validateEventPartLength(i, !1)
                                              ? f.validateEventPartCharacters(i)
                                                  ? o.stringArrayContainsString(s, i)
                                                      ? f.validateEventPartLength(r, !1)
                                                          ? f.validateEventPartCharacters(r)
                                                              ? null
                                                              : (d.w(
                                                          ...
                                                          : (d.w(
                                                            ...
                                                            new g(l.EventValidation, u.ResourceEvent, c.InvalidEventPartLength, v.ItemId, r))
                                                      : (d.w(
                                                            'Validation fail - resource event - itemType: Not found in list of pre-defined available resource itemTypes. String: ' +
                                                                i
                                                        ),
                                                        new g(l.EventValidation, u.ResourceEvent, c.NotFoundInAvailableItemTypes, v.ItemType, i))
                                                  : (d.w(
                                                        'Validation fail - resource event - itemType: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: ' +
                                                            i
                                                    ),
                                                    new g(l.EventValidation, u.ResourceEvent, c.InvalidEventPartCharacters, v.ItemType, i))
                                              : (d.w(
                                                    'Validation fail - resource event - itemType: Cannot be (null), empty or above 64 characters. String: ' +
                                                        i
                                                ),
                                                new g(l.EventValidation, u.ResourceEvent, c.InvalidEventPartLength, v.ItemType, i))
                                          : (d.w('Validation fail - resource event - itemType: Cannot be (null)'),
                                            new g(l.EventValidation, u.ResourceEvent, c.StringEmptyOrNull, v.ItemType, ''))
                                      : (d.w('Validation fail - resource event - amount: Float amount cannot be 0 or negative. Value: ' + t),
                                        new g(l.EventValidation, u.ResourceEvent, c.InvalidAmount, v.Amount, t + ''))
                                  : (d.w(
                                        'Validation fail - resource event - currency: Not found in list of pre-defined available resource currencies. String: ' +
                                            n
                                    ),
                                    new g(l.EventValidation, u.ResourceEvent, c.NotFoundInAvailableCurrencies, v.Currency, n))
                              : (d.w('Validation fail - resource event - currency: Cannot be (null)'),
                                new g(l.EventValidation, u.ResourceEvent, c.StringEmptyOrNull, v.Currency, ''));
                    }),
                    (f.validateProgressionEvent = function (e, n, t, i) {
                        if (e == m.EGAProgressionStatus.Undefined)
                            return (
                                d.w('Validation fail - progression event: Invalid progression status.'),
                                new g(l.EventValidation, u.ProgressionEvent, c.InvalidProgressionStatus, v.ProgressionStatus, '')
                            );
                        if (i && !t && n)
                            return (
                                d.w(
                                ...
                                new g(l.EventValidation, u.ProgressionEvent, c.WrongProgressionOrder, v.Undefined, n + ':' + t + ':' + i)
                            );
                        if (t && !n)
                            return (
                                d.w(
                        ...
                        if (!f.validateEventPartLength(n, !1))
                            return (
                                ...
                                new g(l.EventValidation, u.ProgressionEvent, c.InvalidEventPartLength, v.Progression01, n)
                            );
                        if (!f.validateEventPartCharacters(n))
                            return (
                                ...
                                new g(l.EventValidation, u.ProgressionEvent, c.InvalidEventPartCharacters, v.Progression01, n)
                            );
                        if (t) {
                            if (!f.validateEventPartLength(t, !0))
                                return (
                                    ...
                                    new g(l.EventValidation, u.ProgressionEvent, c.InvalidEventPartLength, v.Progression02, t)
                                );
                            if (!f.validateEventPartCharacters(t))
                                return (
                                    ...
                                    new g(l.EventValidation, u.ProgressionEvent, c.InvalidEventPartCharacters, v.Progression02, t)
                                );
                        }
                        if (i) {
                            if (!f.validateEventPartLength(i, !0))
                                return (
                                    ...
                                    new g(l.EventValidation, u.ProgressionEvent, c.InvalidEventPartLength, v.Progression03, i)
                                );
                            if (!f.validateEventPartCharacters(i))
                                return (
                                    ...
                                    new g(l.EventValidation, u.ProgressionEvent, c.InvalidEventPartCharacters, v.Progression03, i)
                                );
                        }
                        return null;
                    }),
                        ...
                        return f.validateEventIdLength(e)
                            ? f.validateEventIdCharacters(e)
                                ...
                                : (d.w(
                                  ...
                                  new g(l.EventValidation, u.DesignEvent, c.InvalidEventIdCharacters, v.EventId, e))
                            : (d.w(
                              ...
                              new g(l.EventValidation, u.DesignEvent, c.InvalidEventIdLength, v.EventId, e));
                    }),
                    (f.validateErrorEvent = function (e, n) {
                        return e == m.EGAErrorSeverity.Undefined
                            ? (d.w('Validation fail - error event - severity: Severity was unsupported value.'),
                              new g(l.EventValidation, u.ErrorEvent, c.InvalidSeverity, v.Severity, ''))
                            : f.validateLongString(n, !0)
                              ? null
                              : (d.w('Validation fail - error event - message: Message cannot be above 8192 characters.'),
                                new g(l.EventValidation, u.ErrorEvent, c.InvalidLongString, v.Message, n));
                    }),
                    (f.validateAdEvent = function (e, n, t, i) {
                        return e == m.EGAAdAction.Undefined
                            ? (d.w('Validation fail - error event - severity: Severity was unsupported value.'),
                              new g(l.EventValidation, u.AdEvent, c.InvalidAdAction, v.AdAction, ''))
                            : n == m.EGAAdType.Undefined
                              ? (d.w('Validation fail - ad event - adType: Ad type was unsupported value.'),
                                new g(l.EventValidation, u.AdEvent, c.InvalidAdType, v.AdType, ''))
                              : f.validateShortString(t, !1)
                                ? f.validateString(i, !1)
                                    ? null
                                    : (d.w('Validation fail - ad event - message: Ad placement cannot be above 64 characters.'),
                                      new g(l.EventValidation, u.AdEvent, c.InvalidString, v.AdPlacement, i))
                                : (d.w('Validation fail - ad event - message: Ad SDK name cannot be above 32 characters.'),
                                  new g(l.EventValidation, u.AdEvent, c.InvalidShortString, v.AdSdkName, t));
                    }),
                        ...
                        return !(
                            ...
                            (t === l.Undefined
                                ...
                                : i === u.Undefined
                                  ...
                                  : r === c.Undefined && (d.w('Validation fail - sdk error event - type: Action was unsupported value.'), 1))
                        );
                    }),
                    ...
                    (f.validateEngineVersion = function (e) {
                        return !(
                            !e || !o.stringMatch(e, /^(unity|unreal|gamemaker|cocos2d|construct|defold|godot) [0-9]{0,5}(\.[0-9]{0,5}){0,2}$/)
                        );
                    }),
                    (f.validateUserId = function (e) {
                        return (
                            !!f.validateString(e, !1) ||
                            (d.w('Validation fail - user id: id cannot be (null), empty or above 64 characters.'), !1)
                        );
                    }),
                    ...
                    (f.validateResourceCurrencies = function (e) {
                        ...
                        for (var n = 0; n < e.length; ++n)
                            if (!o.stringMatch(e[n], /^[A-Za-z]+$/))
                                return (
                                    d.w('resource currencies validation failed: a resource currency can only be A-Z, a-z. String was: ' + e[n]),
                                    !1
                                );
                        return !0;
                    }),
                    ...
                    (f.validateArrayOfStrings = function (e, n, t, i, r) {
                        ...
                        if (0 < e && r.length > e)
                            return d.w(a + ' validation failed: array cannot exceed ' + e + ' values. It has ' + r.length + ' values.'), !1;
                        for (var s = 0; s < r.length; ++s) {
                            ...
                            if (0 < n && n < o)
                                return (
                                    d.w(
                                        a + ' validation failed: a string exceeded max allowed length (which is: ' + n + '). String was: ' + r[s]
                                    ),
                                    !1
                                );
                        }
            ...
            !(function (e) {
                ...
                var t =
                    ...
                    (r.updateConnectionType = function () {
                        navigator.onLine
                            ? (r.connectionType = 'ios' === r.buildPlatform || 'android' === r.buildPlatform ? 'wwan' : 'lan')
                    ...
                    (r.sdkWrapperVersion = 'javascript 4.4.6'),
        ...
        (function (s) {
            !(function (e) {
                var c,
                    ...
                    t,
                    i,
                    r = s.logging.GALogger;
                ((n = c = e.EGAStoreArgsOperator || (e.EGAStoreArgsOperator = {}))[(n.Equal = 0)] = 'Equal'),
                ...
                var a =
                    ...
                    (v.select = function (e, n, t, i) {
                        ...
                        return (
                            ...
                            0 < i && a.length > i && (a = a.slice(0, i + 1)),
                            a
                        );
                    }),
                    ...
                    (v.load = function (e) {
                        if (v.isStorageAvailable()) {
                            try {
                                (v.instance.eventsStore = JSON.parse(localStorage.getItem(v.StringFormat(v.KeyFormat, e, v.EventsStoreKey)))),
                            ...
                            try {
                                (v.instance.sessionsStore = JSON.parse(
                                    localStorage.getItem(v.StringFormat(v.KeyFormat, e, v.SessionsStoreKey))
                                )),
                            ...
                            try {
                                (v.instance.progressionStore = JSON.parse(
                                    localStorage.getItem(v.StringFormat(v.KeyFormat, e, v.ProgressionStoreKey))
                                )),
                                    v.instance.progressionStore || (v.instance.progressionStore = []);
                            } catch (e) {
                                r.w("Load failed for 'progression' store. Using empty store."), (v.instance.progressionStore = []);
                            }
                            try {
                                (v.instance.storeItems = JSON.parse(localStorage.getItem(v.StringFormat(v.KeyFormat, e, v.ItemsStoreKey)))),
            ...
            (n = e.state || (e.state = {})),
                ...
                (g.setAvailableCustomDimensions01 = function (e) {
                    r.validateCustomDimensions(e) &&
                        ((g.instance.availableCustomDimensions01 = e),
                        g.validateAndFixCurrentDimensions(),
                        v.i('Set available custom01 dimension values: (' + c.joinStringArray(e, ', ') + ')'));
                }),
                ...
                (g.setAvailableCustomDimensions02 = function (e) {
                    r.validateCustomDimensions(e) &&
                        ((g.instance.availableCustomDimensions02 = e),
                        g.validateAndFixCurrentDimensions(),
                        v.i('Set available custom02 dimension values: (' + c.joinStringArray(e, ', ') + ')'));
                }),
                ...
                (g.setAvailableCustomDimensions03 = function (e) {
                    r.validateCustomDimensions(e) &&
                        ((g.instance.availableCustomDimensions03 = e),
                        g.validateAndFixCurrentDimensions(),
                        v.i('Set available custom03 dimension values: (' + c.joinStringArray(e, ', ') + ')'));
                }),
                ...
                (g.setAvailableResourceCurrencies = function (e) {
                    r.validateResourceCurrencies(e) &&
                        ((g.instance.availableResourceCurrencies = e),
                        v.i('Set available resource currencies: (' + c.joinStringArray(e, ', ') + ')'));
                }),
                ...
                (g.setAvailableResourceItemTypes = function (e) {
                    r.validateResourceItemTypes(e) &&
                        ((g.instance.availableResourceItemTypes = e),
                        v.i('Set available resource item types: (' + c.joinStringArray(e, ', ') + ')'));
                }),
                (g.getBuild = function () {
                ...
                (g.setCustomDimension01 = function (e) {
                    (g.instance.currentCustomDimension01 = e),
                        d.setItem(g.getGameKey(), g.Dimension01Key, e),
                        v.i('Set custom01 dimension value: ' + e);
                }),
                (g.setCustomDimension02 = function (e) {
                    (g.instance.currentCustomDimension02 = e),
                        d.setItem(g.getGameKey(), g.Dimension02Key, e),
                        v.i('Set custom02 dimension value: ' + e);
                }),
                (g.setCustomDimension03 = function (e) {
                    (g.instance.currentCustomDimension03 = e),
                        d.setItem(g.getGameKey(), g.Dimension03Key, e),
                        v.i('Set custom03 dimension value: ' + e);
                }),
                ...
                (g.getEventAnnotations = function () {
                    var e = { v: 2 };
                    (e.event_uuid = c.createGuid()),
                        (e.user_id = g.instance.identifier),
                        (e.client_ts = g.getClientTsAdjusted()),
                        (e.sdk_version = a.getRelevantSdkVersion()),
                        (e.os_version = a.osVersion),
                        (e.manufacturer = a.deviceManufacturer),
                        (e.device = a.deviceModel),
                        (e.browser_version = a.browserVersion),
                        (e.platform = a.buildPlatform),
                        (e.session_id = g.instance.sessionId),
                        (e[g.SessionNumKey] = g.instance.sessionNum);
                    var n = a.getConnectionType();
                    if (
                        (r.validateConnectionType(n) && (e.connection_type = n),
                        a.gameEngineVersion && (e.engine_version = a.gameEngineVersion),
                    ...
                    return (
                        g.instance.abId && (e.ab_id = g.instance.abId),
                        g.instance.abVariantId && (e.ab_variant_id = g.instance.abVariantId),
                        g.instance.build && (e.build = g.instance.build),
                        e
                    );
                }),
                ...
                (g.getInitAnnotations = function () {
                    var e = {};
                    return (
                        g.getIdentifier() || g.cacheIdentifier(),
                        d.setItem(g.getGameKey(), g.LastUsedIdentifierKey, g.getIdentifier()),
                        (e.user_id = g.getIdentifier()),
                        (e.sdk_version = a.getRelevantSdkVersion()),
                        (e.os_version = a.osVersion),
                        (e.platform = a.buildPlatform),
                        g.getBuild() ? (e.build = g.getBuild()) : (e.build = null),
                        (e.session_num = g.getSessionNum()),
                        (e.random_salt = g.getSessionNum()),
                        e
                    );
                }),
                ...
                (g.cacheIdentifier = function () {
                    g.instance.userId
                        ? (g.instance.identifier = g.instance.userId)
                        : g.instance.defaultUserId && (g.instance.identifier = g.instance.defaultUserId);
                }),
                (g.ensurePersistedStates = function () {
                    d.isStorageAvailable() && d.load(g.getGameKey());
                    var e = g.instance;
                    e.setDefaultId(
                        null != d.getItem(g.getGameKey(), g.DefaultUserIdKey) ? d.getItem(g.getGameKey(), g.DefaultUserIdKey) : c.createGuid()
                    ),
                        (e.sessionNum =
                            null != d.getItem(g.getGameKey(), g.SessionNumKey) ? Number(d.getItem(g.getGameKey(), g.SessionNumKey)) : 0),
                        (e.transactionNum =
                            null != d.getItem(g.getGameKey(), g.TransactionNumKey) ? Number(d.getItem(g.getGameKey(), g.TransactionNumKey)) : 0),
                        e.currentCustomDimension01
                            ? d.setItem(g.getGameKey(), g.Dimension01Key, e.currentCustomDimension01)
                            : ((e.currentCustomDimension01 =
                                  null != d.getItem(g.getGameKey(), g.Dimension01Key) ? d.getItem(g.getGameKey(), g.Dimension01Key) : ''),
                              e.currentCustomDimension01),
                        e.currentCustomDimension02
                            ? d.setItem(g.getGameKey(), g.Dimension02Key, e.currentCustomDimension02)
                            : ((e.currentCustomDimension02 =
                                  null != d.getItem(g.getGameKey(), g.Dimension02Key) ? d.getItem(g.getGameKey(), g.Dimension02Key) : ''),
                              e.currentCustomDimension02),
                        e.currentCustomDimension03
                            ? d.setItem(g.getGameKey(), g.Dimension03Key, e.currentCustomDimension03)
                            : ((e.currentCustomDimension03 =
                                  null != d.getItem(g.getGameKey(), g.Dimension03Key) ? d.getItem(g.getGameKey(), g.Dimension03Key) : ''),
                              e.currentCustomDimension03);
                    ...
                    if (n) {
                        ...
                        if (t) {
                            ...
                            null != i &&
                                i != g.getIdentifier() &&
                                (v.w('New identifier spotted compared to last one used, clearing cached configs hash!!'),
                                t.configs_hash && delete t.configs_hash),
                                (e.sdkConfigCached = t);
                        }
                    }
                    var r = g.getSdkConfig();
                    (e.configsHash = r.configs_hash ? r.configs_hash : ''),
                        (e.abId = r.ab_id ? r.ab_id : ''),
                        (e.abVariantId = r.ab_variant_id ? r.ab_variant_id : '');
                                ...
                                if (i < g.MAX_CUSTOM_FIELDS_COUNT) {
                                    ...
                                    if (c.stringMatch(r, s)) {
                                        ...
                                        if ('string' == o || a instanceof String)
                                            a.length <= g.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH && 0 < a.length
                                                ? ((t[r] = a), ++i)
                                                : ((u = g.formatString(
                                                      (l =
                                                          ...
                                                          g.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH +
                                                          ')'),
                                                      [r, a]
                                                  )),
                                                  v.w(u),
                                        ...
                                        (u = g.formatString(
                                            (l =
                                                ...
                                                g.MAX_CUSTOM_FIELDS_KEY_LENGTH +
                                                ')'),
                                            [r, a]
                                        )),
                                            v.w(u),
                ...
                (g.validateAndFixCurrentDimensions = function () {
                    r.validateDimension01(g.getCurrentCustomDimension01(), g.getAvailableCustomDimensions01()) || g.setCustomDimension01(''),
                        r.validateDimension02(g.getCurrentCustomDimension02(), g.getAvailableCustomDimensions02()) || g.setCustomDimension02(''),
                        r.validateDimension03(g.getCurrentCustomDimension03(), g.getAvailableCustomDimensions03()) || g.setCustomDimension03('');
                }),
                ...
                (g.MAX_CUSTOM_FIELDS_COUNT = 50),
                (g.MAX_CUSTOM_FIELDS_KEY_LENGTH = 64),
                (g.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH = 256),
                (g.instance = new g()),
                (g.DefaultUserIdKey = 'default_user_id'),
                (g.SessionNumKey = 'session_num'),
                (g.TransactionNumKey = 'transaction_num'),
                (g.Dimension01Key = 'dimension01'),
                (g.Dimension02Key = 'dimension02'),
                (g.Dimension03Key = 'dimension03'),
                (g.SdkConfigCachedKey = 'sdk_config_cached'),
                (g.LastUsedIdentifierKey = 'last_used_identifier'),
                (i = g),
                (n.GAState = i);
        })((gameanalytics = gameanalytics || {})),
        (function (e) {
            ...
            (n = e.tasks || (e.tasks = {})),
                ...
                (l.execute = function (e, n, t, i) {
                    var r = new Date();
                    if (
                        (l.timestampMap[n] || (l.timestampMap[n] = r),
                        l.countMap[n] || (l.countMap[n] = 0),
                        3600 <= (r.getTime() - l.timestampMap[n].getTime()) / 1e3 && ((l.timestampMap[n] = r), (l.countMap[n] = 0)),
                        !(l.countMap[n] >= l.MaxCount))
                    ) {
                        var a = o.getHmac(i, t),
            ...
            (u = e.http || (e.http = {})),
                    ...
                    if (0 != e.length) {
                        ...
                        if (a) {
                            ...
                            o.push(a),
                                ...
                                y.sendRequest(r, s, o, this.useGzip, y.sendEventInArrayRequestCallback, t);
                ...
                (y.prototype.sendSdkErrorEvent = function (e, n, t, i, r, a, s) {
                    if (p.isEventSubmissionEnabled() && A.validateSdkErrorEvent(a, s, e, n, t)) {
                        var o,
                            d = this.baseUrl + '/' + a + '/' + this.eventsUrlPath,
                            l = '',
                ...
                (y.sendEventInArrayRequestCallback = function (e, n, t, i) {
                    ...
                    if (d == u.EGAHTTPApiResponse.Ok || d == u.EGAHTTPApiResponse.Created || d == u.EGAHTTPApiResponse.BadRequest) {
                        ...
                        if (null == l)
                            return (
                                t(u.EGAHTTPApiResponse.JsonDecodeFailed, null, s, o),
                ...
                (y.initRequestCallback = function (e, n, t, i) {
                    ...
                    if (o == u.EGAHTTPApiResponse.Ok || o == u.EGAHTTPApiResponse.Created || o == u.EGAHTTPApiResponse.BadRequest) {
                        if (null == s)
                            return (
                                t(u.EGAHTTPApiResponse.JsonDecodeFailed, null, '', 0),
                                void y.instance.sendSdkErrorEvent(
                                    v.Http,
                                    g.InitHttp,
                                    f.FailHttpJsonDecode,
                ...
                (y.prototype.processRequestResponse = function (e, n, t, i) {
                    return t
                        ? 200 === e
                            ? u.EGAHTTPApiResponse.Ok
                            : 201 === e
                              ? u.EGAHTTPApiResponse.Created
                              : 0 === e || 401 === e
                                ? u.EGAHTTPApiResponse.Unauthorized
                                : 400 === e
                                  ? u.EGAHTTPApiResponse.BadRequest
                                  : 500 === e
                                    ? u.EGAHTTPApiResponse.InternalServerError
                                    : u.EGAHTTPApiResponse.UnknownResponseCode
                        : u.EGAHTTPApiResponse.NoResponse;
                }),
        ...
        (function (E) {
            ...
            (g = E.events || (E.events = {})),
                (f = E.store.GAStore),
                (m = E.store.EGAStore),
                (p = E.store.EGAStoreArgsOperator),
                (S = E.state.GAState),
                (A = E.logging.GALogger),
                (h = E.utilities.GAUtilities),
                (l = E.http.EGAHTTPApiResponse),
                (y = E.http.GAHTTPApi),
                (b = E.validators.GAValidator),
                (C.customEventFieldsErrorCallback = function (e, n) {
                    if (S.isEventSubmissionEnabled()) {
                        var t = new Date();
                        C.timestampMap[e] || (C.timestampMap[e] = t),
                            C.countMap[e] || (C.countMap[e] = 0),
                            3600 <= (t.getTime() - C.timestampMap[e].getTime()) / 1e3 && ((C.timestampMap[e] = t), (C.countMap[e] = 0)),
                            C.countMap[e] >= C.MAX_ERROR_COUNT ||
                ...
                (C.addSessionStartEvent = function () {
                    if (S.isEventSubmissionEnabled()) {
                        ...
                        (e.category = C.CategorySessionStart),
                            ...
                            f.setItem(S.getGameKey(), S.SessionNumKey, S.getSessionNum().toString()),
                    ...
                    if ((void 0 === r && (r = null), S.isEventSubmissionEnabled())) {
                        ...
                        if (null == o) {
                            ...
                            S.incrementTransactionNum(),
                                f.setItem(S.getGameKey(), S.TransactionNumKey, S.getTransactionNum().toString()),
                                (d.event_id = t + ':' + i),
                                (d.category = C.CategoryBusiness),
                                (d.currency = e),
                                (d.amount = n),
                                (d[S.TransactionNumKey] = S.getTransactionNum()),
                                r && (d.cart_type = r),
                                C.addDimensionsToEvent(d);
                            var l = {};
                            if (a && 0 < Object.keys(a).length) for (var u in a) l[u] = a[u];
                            else for (var u in S.instance.currentGlobalCustomEventFields) l[u] = S.instance.currentGlobalCustomEventFields[u];
                            if (s && a && 0 < Object.keys(a).length)
                                for (var u in S.instance.currentGlobalCustomEventFields)
                                    l[u] || (l[u] = S.instance.currentGlobalCustomEventFields[u]);
                            C.addCustomFieldsToEvent(d, S.validateAndCleanCustomFields(l, C.customEventFieldsErrorCallback)),
                                A.i(
                            ...
                            y.instance.sendSdkErrorEvent(o.category, o.area, o.action, o.parameter, o.reason, S.getGameKey(), S.getGameSecret());
                    }
                }),
                (C.addResourceEvent = function (e, n, t, i, r, a, s) {
                    if (S.isEventSubmissionEnabled()) {
                        ...
                        if (null == o) {
                            ...
                            (d.event_id = l + ':' + n + ':' + i + ':' + r),
                                (d.category = C.CategoryResource),
                                (d.amount = t),
                                C.addDimensionsToEvent(d);
                            var u = {};
                            if (a && 0 < Object.keys(a).length) for (var c in a) u[c] = a[c];
                            else for (var c in S.instance.currentGlobalCustomEventFields) u[c] = S.instance.currentGlobalCustomEventFields[c];
                            if (s && a && 0 < Object.keys(a).length)
                                for (var c in S.instance.currentGlobalCustomEventFields)
                                    u[c] || (u[c] = S.instance.currentGlobalCustomEventFields[c]);
                            C.addCustomFieldsToEvent(d, S.validateAndCleanCustomFields(u, C.customEventFieldsErrorCallback)),
                                A.i('Add RESOURCE event: {currency:' + n + ', amount:' + t + ', itemType:' + i + ', itemId:' + r + '}'),
                                C.addEventToStore(d);
                        } else
                            y.instance.sendSdkErrorEvent(o.category, o.area, o.action, o.parameter, o.reason, S.getGameKey(), S.getGameSecret());
                    }
                    ...
                    if (S.isEventSubmissionEnabled()) {
                        ...
                        if (null == l) {
                            var u,
                                c = {};
                            (u = t ? (i ? n + ':' + t + ':' + i : n + ':' + t) : n),
                                (c.category = C.CategoryProgression),
                                (c.event_id = d + ':' + u);
                            var v = 0;
                            a && e != E.EGAProgressionStatus.Start && (c.score = Math.round(r)),
                                e === E.EGAProgressionStatus.Fail && S.incrementProgressionTries(u),
                                e === E.EGAProgressionStatus.Complete &&
                                    (S.incrementProgressionTries(u),
                                    (v = S.getProgressionTries(u)),
                                    (c.attempt_num = v),
                                    S.clearProgressionTries(u)),
                                C.addDimensionsToEvent(c);
                            var g = {};
                            if (s && 0 < Object.keys(s).length) for (var f in s) g[f] = s[f];
                            else for (var f in S.instance.currentGlobalCustomEventFields) g[f] = S.instance.currentGlobalCustomEventFields[f];
                            ...
                            C.addCustomFieldsToEvent(c, S.validateAndCleanCustomFields(g, C.customEventFieldsErrorCallback)),
                                A.i(
                            ...
                            y.instance.sendSdkErrorEvent(l.category, l.area, l.action, l.parameter, l.reason, S.getGameKey(), S.getGameSecret());
                    }
                }),
                (C.addDesignEvent = function (e, n, t, i, r) {
                    if (S.isEventSubmissionEnabled()) {
                        ...
                        if (null == a) {
                            ...
                            var o = {};
                            if (i && 0 < Object.keys(i).length) for (var d in i) o[d] = i[d];
                            else for (var d in S.instance.currentGlobalCustomEventFields) o[d] = S.instance.currentGlobalCustomEventFields[d];
                            if (r && i && 0 < Object.keys(i).length)
                                for (var d in S.instance.currentGlobalCustomEventFields)
                                    o[d] || (o[d] = S.instance.currentGlobalCustomEventFields[d]);
                            C.addCustomFieldsToEvent(s, S.validateAndCleanCustomFields(o, C.customEventFieldsErrorCallback)),
                                A.i('Add DESIGN event: {eventId:' + e + ', value:' + n + '}'),
                                C.addEventToStore(s);
                        } else
                            y.instance.sendSdkErrorEvent(a.category, a.area, a.action, a.parameter, a.reason, S.getGameKey(), S.getGameSecret());
                    }
                }),
                    ...
                    if ((void 0 === r && (r = !1), S.isEventSubmissionEnabled())) {
                        ...
                        if (null == s) {
                            ...
                            if (((o.category = C.CategoryError), (o.severity = a), (o.message = n), C.addDimensionsToEvent(o), !r)) {
                                var d = {};
                                if (t && 0 < Object.keys(t).length) for (var l in t) d[l] = t[l];
                                else
                                ...
                                if (i && t && 0 < Object.keys(t).length)
                                    for (var l in S.instance.currentGlobalCustomEventFields)
                                        d[l] || (d[l] = S.instance.currentGlobalCustomEventFields[l]);
                            ...
                            y.instance.sendSdkErrorEvent(s.category, s.area, s.action, s.parameter, s.reason, S.getGameKey(), S.getGameSecret());
                    }
                }),
                (C.addAdEvent = function (e, n, t, i, r, a, s, o, d) {
                    if (S.isEventSubmissionEnabled()) {
                        ...
                        if (null == v) {
                            var g = {};
                            (g.category = C.CategoryAds),
                                (g.ad_sdk_name = t),
                                (g.ad_placement = i),
                                (g.ad_type = u),
                                (g.ad_action = l),
                                e == E.EGAAdAction.FailedShow && 0 < c.length && (g.ad_fail_show_reason = c),
                                !s || (n != E.EGAAdType.RewardedVideo && n != E.EGAAdType.Video) || (g.ad_duration = a),
                                C.addDimensionsToEvent(g);
                            var f = {};
                            if (o && 0 < Object.keys(o).length) for (var m in o) f[m] = o[m];
                            else for (var m in S.instance.currentGlobalCustomEventFields) f[m] = S.instance.currentGlobalCustomEventFields[m];
                            if (d && o && 0 < Object.keys(o).length)
                                for (var m in S.instance.currentGlobalCustomEventFields)
                                    f[m] || (f[m] = S.instance.currentGlobalCustomEventFields[m]);
                            C.addCustomFieldsToEvent(g, S.validateAndCleanCustomFields(f, C.customEventFieldsErrorCallback)),
                                A.i(
                                    'Add AD event: {ad_sdk_name:' +
                                        ...
                                        ', ad_action:' +
                                        l +
                                        (e == E.EGAAdAction.FailedShow && 0 < c.length ? ', ad_fail_show_reason:' + c : '') +
                                        (!s || (n != E.EGAAdType.RewardedVideo && n != E.EGAAdType.Video) ? '' : ', ad_duration:' + a) +
                                        '}'
                                ),
                                C.addEventToStore(g);
                        } else
                            y.instance.sendSdkErrorEvent(v.category, v.area, v.action, v.parameter, v.reason, S.getGameKey(), S.getGameSecret());
                    }
                }),
                        ...
                        try {
                            ...
                            A.e('Error during ProcessEvents(): ' + e.stack),
                                y.instance.sendSdkErrorEvent(
                                    g.EGASdkErrorCategory.Json,
                                    g.EGASdkErrorArea.ProcessEvents,
                                    g.EGASdkErrorAction.JsonError,
                                    g.EGASdkErrorParameter.Undefined,
                                    e.stack,
                                    S.getGameKey(),
                                    S.getGameSecret()
                                );
                ...
                (C.processEventsCallback = function (e, n, t, i) {
                    ...
                    if ((r.push(['status', p.Equal, t]), e === l.Ok)) f.delete(m.Events, r), A.i('Event queue: ' + i + ' events sent.');
                        ...
                        var a = [];
                        a.push(['status', 'new']),
                            A.w('Event queue: Failed to send events to collector - Retrying next time'),
                            f.update(m.Events, a, r);
                    } else {
                        if (n) {
                            var s,
                                o = 0;
                            for (var d in n) 0 == o && (s = n[d]), ++o;
                            e === l.BadRequest && s.constructor === Array
                                ? A.w('Event queue: ' + i + ' events sent. ' + o + ' events failed GA server validation.')
                ...
                (C.addEventToStore = function (e) {
                    if (S.isEventSubmissionEnabled())
                        if (S.isInitialized())
                            try {
                                if (f.isStoreTooLargeForEvents() && !h.stringMatch(e.category, /^(user|session_end|business)$/))
                                    return (
                                        A.w('Database too large. Event has been blocked.'),
                                        void y.instance.sendSdkErrorEvent(
                                            g.EGASdkErrorCategory.Database,
                                            g.EGASdkErrorArea.AddEventsToStore,
                                            g.EGASdkErrorAction.DatabaseTooLarge,
                                            g.EGASdkErrorParameter.Undefined,
                                            '',
                                            S.getGameKey(),
                                            S.getGameSecret()
                                ...
                                (r.category = n.category),
                                    (r.session_id = n.session_id),
                                    (r.client_ts = n.client_ts),
                                    (r.event = h.encode64(JSON.stringify(n))),
                                    f.insert(m.Events, r),
                                    e.category == C.CategorySessionEnd
                                        ? f.delete(m.Sessions, [['session_id', p.Equal, n.session_id]])
                                        : C.updateSessionStore(),
                                    f.isStorageAvailable() && f.save(S.getGameKey());
                            } catch (t) {
                ...
                (C.updateSessionStore = function () {
                    if (S.sessionIsStarted()) {
                        ...
                        C.addCustomFieldsToEvent(n, S.validateAndCleanCustomFields(t, C.customEventFieldsErrorCallback)),
                            (e.event = h.encode64(JSON.stringify(n))),
                            f.insert(m.Sessions, e, !0, 'session_id'),
                            f.isStorageAvailable() && f.save(S.getGameKey());
                    }
                }),
                ...
                (C.resourceFlowTypeToString = function (e) {
                    return e == E.EGAResourceFlowType.Source || e == E.EGAResourceFlowType[E.EGAResourceFlowType.Source]
                        ? 'Source'
                        : e == E.EGAResourceFlowType.Sink || e == E.EGAResourceFlowType[E.EGAResourceFlowType.Sink]
                          ? 'Sink'
                          : '';
                }),
                (C.progressionStatusToString = function (e) {
                    return e == E.EGAProgressionStatus.Start || e == E.EGAProgressionStatus[E.EGAProgressionStatus.Start]
                        ? 'Start'
                        : e == E.EGAProgressionStatus.Complete || e == E.EGAProgressionStatus[E.EGAProgressionStatus.Complete]
                          ? 'Complete'
                          : e == E.EGAProgressionStatus.Fail || e == E.EGAProgressionStatus[E.EGAProgressionStatus.Fail]
                            ? 'Fail'
                            : '';
                }),
                (C.errorSeverityToString = function (e) {
                    return e == E.EGAErrorSeverity.Debug || e == E.EGAErrorSeverity[E.EGAErrorSeverity.Debug]
                        ? 'debug'
                        : e == E.EGAErrorSeverity.Info || e == E.EGAErrorSeverity[E.EGAErrorSeverity.Info]
                          ? 'info'
                          : e == E.EGAErrorSeverity.Warning || e == E.EGAErrorSeverity[E.EGAErrorSeverity.Warning]
                            ? 'warning'
                            : e == E.EGAErrorSeverity.Error || e == E.EGAErrorSeverity[E.EGAErrorSeverity.Error]
                              ? 'error'
                              : e == E.EGAErrorSeverity.Critical || e == E.EGAErrorSeverity[E.EGAErrorSeverity.Critical]
                                ? 'critical'
                                : '';
                }),
                (C.adActionToString = function (e) {
                    return e == E.EGAAdAction.Clicked || e == E.EGAAdAction[E.EGAAdAction.Clicked]
                        ? 'clicked'
                        : e == E.EGAAdAction.Show || e == E.EGAAdAction[E.EGAAdAction.Show]
                          ? 'show'
                          : e == E.EGAAdAction.FailedShow || e == E.EGAAdAction[E.EGAAdAction.FailedShow]
                            ? 'failed_show'
                            : e == E.EGAAdAction.RewardReceived || e == E.EGAAdAction[E.EGAAdAction.RewardReceived]
                              ? 'reward_received'
                              : '';
                }),
                (C.adErrorToString = function (e) {
                    return e == E.EGAAdError.Unknown || e == E.EGAAdError[E.EGAAdError.Unknown]
                        ? 'unknown'
                        : e == E.EGAAdError.Offline || e == E.EGAAdError[E.EGAAdError.Offline]
                          ? 'offline'
                          : e == E.EGAAdError.NoFill || e == E.EGAAdError[E.EGAAdError.NoFill]
                            ? 'no_fill'
                            : e == E.EGAAdError.InternalError || e == E.EGAAdError[E.EGAAdError.InternalError]
                              ? 'internal_error'
                              : e == E.EGAAdError.InvalidRequest || e == E.EGAAdError[E.EGAAdError.InvalidRequest]
                                ? 'invalid_request'
                                : e == E.EGAAdError.UnableToPrecache || e == E.EGAAdError[E.EGAAdError.UnableToPrecache]
                                  ? 'unable_to_precache'
                                  : '';
                }),
                (C.adTypeToString = function (e) {
                    return e == E.EGAAdType.Video || e == E.EGAAdType[E.EGAAdType.Video]
                        ? 'video'
                        : e == E.EGAAdType.RewardedVideo || e == E.EGAAdError[E.EGAAdType.RewardedVideo]
                          ? 'rewarded_video'
                          : e == E.EGAAdType.Playable || e == E.EGAAdError[E.EGAAdType.Playable]
                            ? 'playable'
                            : e == E.EGAAdType.Interstitial || e == E.EGAAdError[E.EGAAdType.Interstitial]
                              ? 'interstitial'
                              : e == E.EGAAdType.OfferWall || e == E.EGAAdError[E.EGAAdType.OfferWall]
                                ? 'offer_wall'
                                : e == E.EGAAdType.Banner || e == E.EGAAdError[E.EGAAdType.Banner]
                                  ? 'banner'
                                  : '';
                }),
        ...
        (function (e) {
            ...
            (r = e.threading || (e.threading = {})),
                ...
                (t = e.state.GAState),
                (i = e.events.GAEvents),
                (s.createTimedBlock = function (e) {
                    void 0 === e && (e = 0);
                    var n = new Date();
                    return n.setUTCSeconds(n.getUTCSeconds() + e), new r.TimedBlock(n);
                }),
                (s.performTaskOnGAThread = function (e, n) {
                    void 0 === n && (n = 0);
                    var t = new Date();
                    t.setUTCSeconds(t.getUTCSeconds() + n);
                ...
                (s.ensureEventQueueIsRunning = function () {
                    (s.instance.keepRunning = !0),
                        s.instance.isRunning ||
                            ((s.instance.isRunning = !0), s.scheduleTimer(s.ProcessEventsIntervalInSeconds, s.processEventQueue));
                }),
                (s.endSessionAndStopQueue = function () {
                    t.isInitialized() &&
                        (n.i('Ending session.'),
                        s.stopEventQueue(),
                        t.isEnabled() && t.sessionIsStarted() && (i.addSessionEndEvent(), (t.instance.sessionStart = 0)));
                }),
                ...
                (s.getNextBlock = function () {
                    var e = new Date();
                    return s.instance.blocks.hasItems() && s.instance.blocks.peek().deadline.getTime() <= e.getTime()
                ...
                (s.processEventQueue = function () {
                    i.processEvents('', !0),
                        s.instance.keepRunning
                            ? s.scheduleTimer(s.ProcessEventsIntervalInSeconds, s.processEventQueue)
                            : (s.instance.isRunning = !1);
                }),
                (s.instance = new s()),
            ...
            var l = d.threading.GAThreading,
                ...
                n =
                    ...
                    (E.init = function () {
                        if (
                            (v.touch(),
                            (E.methodMap.configureAvailableCustomDimensions01 = E.configureAvailableCustomDimensions01),
                            (E.methodMap.configureAvailableCustomDimensions02 = E.configureAvailableCustomDimensions02),
                            (E.methodMap.configureAvailableCustomDimensions03 = E.configureAvailableCustomDimensions03),
                            (E.methodMap.configureAvailableResourceCurrencies = E.configureAvailableResourceCurrencies),
                            (E.methodMap.configureAvailableResourceItemTypes = E.configureAvailableResourceItemTypes),
                            (E.methodMap.configureBuild = E.configureBuild),
                            (E.methodMap.configureSdkGameEngineVersion = E.configureSdkGameEngineVersion),
                            (E.methodMap.configureGameEngineVersion = E.configureGameEngineVersion),
                            (E.methodMap.configureUserId = E.configureUserId),
                            (E.methodMap.initialize = E.initialize),
                            (E.methodMap.addBusinessEvent = E.addBusinessEvent),
                            (E.methodMap.addResourceEvent = E.addResourceEvent),
                            (E.methodMap.addProgressionEvent = E.addProgressionEvent),
                            (E.methodMap.addDesignEvent = E.addDesignEvent),
                            (E.methodMap.addErrorEvent = E.addErrorEvent),
                            (E.methodMap.addAdEvent = E.addAdEvent),
                            (E.methodMap.setEnabledInfoLog = E.setEnabledInfoLog),
                            (E.methodMap.setEnabledVerboseLog = E.setEnabledVerboseLog),
                            (E.methodMap.setEnabledManualSessionHandling = E.setEnabledManualSessionHandling),
                            (E.methodMap.setEnabledEventSubmission = E.setEnabledEventSubmission),
                            (E.methodMap.setCustomDimension01 = E.setCustomDimension01),
                            (E.methodMap.setCustomDimension02 = E.setCustomDimension02),
                            (E.methodMap.setCustomDimension03 = E.setCustomDimension03),
                            (E.methodMap.setGlobalCustomEventFields = E.setGlobalCustomEventFields),
                            (E.methodMap.setEventProcessInterval = E.setEventProcessInterval),
                            (E.methodMap.startSession = E.startSession),
                            (E.methodMap.endSession = E.endSession),
                            (E.methodMap.onStop = E.onStop),
                            (E.methodMap.onResume = E.onResume),
                            (E.methodMap.addRemoteConfigsListener = E.addRemoteConfigsListener),
                            (E.methodMap.removeRemoteConfigsListener = E.removeRemoteConfigsListener),
                            (E.methodMap.getRemoteConfigsValueAsString = E.getRemoteConfigsValueAsString),
                            (E.methodMap.isRemoteConfigsReady = E.isRemoteConfigsReady),
                            (E.methodMap.getRemoteConfigsContentAsString = E.getRemoteConfigsContentAsString),
                            (E.methodMap.addOnBeforeUnloadListener = E.addOnBeforeUnloadListener),
                            (E.methodMap.removeOnBeforeUnloadListener = E.removeOnBeforeUnloadListener),
                            void 0 !== E.getGlobalObject() &&
                                void 0 !== E.getGlobalObject().GameAnalytics &&
                                void 0 !== E.getGlobalObject().GameAnalytics.q)
                        ) {
                        ...
                        window.addEventListener('beforeunload', function (e) {
                            console.log('addEventListener unload'),
                                (c.instance.isUnloading = !0),
                                c.notifyBeforeUnloadListeners(),
                    ...
                    (E.gaCommand = function () {
                        ...
                        0 < e.length &&
                            e[0] in d.GameAnalytics.methodMap &&
                            (1 < e.length
                                ? d.GameAnalytics.methodMap[e[0]].apply(null, Array.prototype.slice.call(e, 1))
                                : d.GameAnalytics.methodMap[e[0]]());
                    }),
                    (E.configureAvailableCustomDimensions01 = function (e) {
                        void 0 === e && (e = []),
                            l.performTaskOnGAThread(function () {
                                E.isSdkReady(!0, !1)
                                    ? o.w('Available custom dimensions must be set before SDK is initialized')
                                    : c.setAvailableCustomDimensions01(e);
                            });
                    }),
                    (E.configureAvailableCustomDimensions02 = function (e) {
                        void 0 === e && (e = []),
                            l.performTaskOnGAThread(function () {
                                E.isSdkReady(!0, !1)
                                    ? o.w('Available custom dimensions must be set before SDK is initialized')
                                    : c.setAvailableCustomDimensions02(e);
                            });
                    }),
                    (E.configureAvailableCustomDimensions03 = function (e) {
                        void 0 === e && (e = []),
                            l.performTaskOnGAThread(function () {
                                E.isSdkReady(!0, !1)
                                    ? o.w('Available custom dimensions must be set before SDK is initialized')
                                    : c.setAvailableCustomDimensions03(e);
                            });
                    }),
                    (E.configureAvailableResourceCurrencies = function (e) {
                        void 0 === e && (e = []),
                            l.performTaskOnGAThread(function () {
                                E.isSdkReady(!0, !1)
                                    ? o.w('Available resource currencies must be set before SDK is initialized')
                                    : c.setAvailableResourceCurrencies(e);
                            });
                    }),
                    (E.configureAvailableResourceItemTypes = function (e) {
                        void 0 === e && (e = []),
                            l.performTaskOnGAThread(function () {
                                E.isSdkReady(!0, !1)
                                    ? o.w('Available resource item types must be set before SDK is initialized')
                                    : c.setAvailableResourceItemTypes(e);
                            });
                    }),
                    (E.configureBuild = function (e) {
                        void 0 === e && (e = ''),
                            l.performTaskOnGAThread(function () {
                                E.isSdkReady(!0, !1)
                                    ? o.w('Build version must be set before SDK is initialized.')
                                    : i.validateBuild(e)
                                      ? c.setBuild(e)
                                      : o.i('Validation fail - configure build: Cannot be null, empty or above 32 length. String: ' + e);
                            });
                    }),
                            ...
                            l.performTaskOnGAThread(function () {
                                E.isSdkReady(!0, !1) ||
                                    (i.validateSdkWrapperVersion(e)
                                        ? (v.sdkGameEngineVersion = e)
                                        : o.i('Validation fail - configure sdk version: Sdk version not supported. String: ' + e));
                            });
                    }),
                            ...
                            l.performTaskOnGAThread(function () {
                                E.isSdkReady(!0, !1) ||
                                    (i.validateEngineVersion(e)
                                        ? (v.gameEngineVersion = e)
                                        : o.i(
                                              'Validation fail - configure game engine version: Game engine version not supported. String: ' + e
                                          ));
                            });
                    }),
                    (E.configureUserId = function (e) {
                        void 0 === e && (e = ''),
                            l.performTaskOnGAThread(function () {
                                E.isSdkReady(!0, !1)
                                    ? o.w('A custom user id must be set before SDK is initialized.')
                                    : i.validateUserId(e)
                                      ? c.setUserId(e)
                                      : o.i(
                    ...
                    (E.initialize = function (e, n) {
                        ...
                        (t.async = !0),
                            (E.initTimedBlockId = t.id),
                            (t.block = function () {
                                E.isSdkReady(!0, !1)
                                    ? o.w('SDK already initialized. Can only be called once.')
                                    : i.validateKeys(e, n)
                                      ? (c.setKeys(e, n), E.internalInitialize())
                                      : o.w(
                    ...
                    (E.addResourceEvent = function (e, n, t, i, r, a, s) {
                        if (
                            (void 0 === e && (e = d.EGAResourceFlowType.Undefined),
                            void 0 === n && (n = ''),
                            void 0 === t && (t = 0),
                            void 0 === i && (i = ''),
                            void 0 === r && (r = ''),
                    ...
                    (E.addProgressionEvent = function (n, t, i, r, a, s, o) {
                        if (
                            (void 0 === n && (n = d.EGAProgressionStatus.Undefined),
                            void 0 === t && (t = ''),
                            void 0 === i && (i = ''),
                            void 0 === r && (r = ''),
                            void 0 === s && (s = {}),
                    ...
                    (E.addErrorEvent = function (e, n, t, i) {
                        if (
                            (void 0 === e && (e = d.EGAErrorSeverity.Undefined),
                            void 0 === n && (n = ''),
                            void 0 === t && (t = {}),
                            void 0 === i && (i = !1),
                            v.updateConnectionType(),
                    ...
                    (E.addAdEventWithNoAdReason = function (e, n, t, i, r, a, s) {
                        if (
                            (void 0 === e && (e = d.EGAAdAction.Undefined),
                            void 0 === n && (n = d.EGAAdType.Undefined),
                            void 0 === t && (t = ''),
                            void 0 === i && (i = ''),
                            void 0 === r && (r = d.EGAAdError.Undefined),
                            void 0 === a && (a = {}),
                            void 0 === s && (s = !1),
                            v.updateConnectionType(),
                            c.instance.isUnloading)
                    ...
                    (E.setEnabledEventSubmission = function (e) {
                        void 0 === e && (e = !1),
                            l.performTaskOnGAThread(function () {
                                e
                                    ? (c.setEnabledEventSubmission(e), o.i('Event submission enabled'))
                                    : (o.i('Event submission disabled'), c.setEnabledEventSubmission(e));
                            });
                    }),
                    (E.setCustomDimension01 = function (e) {
                        void 0 === e && (e = ''),
                            l.performTaskOnGAThread(function () {
                                i.validateDimension01(e, c.getAvailableCustomDimensions01())
                                    ? c.setCustomDimension01(e)
                                    : o.w(
                    ...
                    (E.setCustomDimension02 = function (e) {
                        void 0 === e && (e = ''),
                            l.performTaskOnGAThread(function () {
                                i.validateDimension02(e, c.getAvailableCustomDimensions02())
                                    ? c.setCustomDimension02(e)
                                    : o.w(
                    ...
                    (E.setCustomDimension03 = function (e) {
                        void 0 === e && (e = ''),
                            l.performTaskOnGAThread(function () {
                                i.validateDimension03(e, c.getAvailableCustomDimensions03())
                                    ? c.setCustomDimension03(e)
                                    : o.w(
                    ...
                    (E.internalInitialize = function () {
                        c.ensurePersistedStates(),
                            u.setItem(c.getGameKey(), c.DefaultUserIdKey, c.getDefaultId()),
                            c.setInitialized(!0),
                            E.newSession(),
                            c.isEnabled() && l.ensureEventQueueIsRunning();
                    }),
                    (E.newSession = function () {
                        o.i('Starting a new session.'),
                            c.validateAndFixCurrentDimensions(),
                            e.instance.requestInit(c.instance.configsHash, E.startNewSessionCallback);
                    }),
                    (E.startNewSessionCallback = function (e, n) {
                        if ((e !== g.Ok && e !== g.Created) || !n)
                            e == g.Unauthorized
                                ? (o.w('Initialize SDK failed - Unauthorized'), (c.instance.initAuthorized = !1))
                                : (e === g.NoResponse || e === g.RequestTimeout
                                      ? o.i('Init call (session start) failed - no response. Could be offline or timeout.')
                                      : e === g.BadResponse || e === g.JsonEncodeFailed || e === g.JsonDecodeFailed
                                        ? o.i('Init call (session start) failed - bad response. Could be bad response from proxy or GA servers.')
                                        : (e !== g.BadRequest && e !== g.UnknownResponseCode) ||
                                          o.i('Init call (session start) failed - bad request or unknown response.'),
                                  null == c.instance.sdkConfig
                                      ? null != c.instance.sdkConfigCached
                                          ? (o.i('Init call (session start) failed - using cached init values.'),
                                            (c.instance.sdkConfig = c.instance.sdkConfigCached))
                                          : (o.i('Init call (session start) failed - using default init values.'),
                                            (c.instance.sdkConfig = c.instance.sdkConfigDefault))
                                      : o.i('Init call (session start) failed - using cached init values.'),
                            ...
                            (c.instance.configsHash = n.configs_hash ? n.configs_hash : ''),
                                ...
                                u.setItem(c.getGameKey(), c.SdkConfigCachedKey, f.encode64(JSON.stringify(n))),
                                (c.instance.sdkConfigCached = n),
                                (c.instance.sdkConfig = n),
                                (c.instance.initAuthorized = !0);
                        }
                        if (
                            ((c.instance.clientServerTimeOffset = c.getSdkConfig().time_offset ? c.getSdkConfig().time_offset : 0),
                            c.populateConfigurations(c.getSdkConfig()),
                            !c.isEnabled())
                        )
                            return o.w('Could not start session: SDK is disabled.'), void l.stopEventQueue();
                    ...
                    (E.isSdkReady = function (e, n, t) {
                        return (
                            ...
                            t && (t += ': '),
                            e && !c.isInitialized()
                                ? (n && o.w(t + 'SDK is not initialized'), !1)
                                : e && !c.isEnabled()
                                  ? (n && o.w(t + 'SDK is disabled'), !1)
                                  : !(e && !c.sessionIsStarted() && (n && o.w(t + 'Session has not started yet'), 1))
                        );
                    }),
                    (E.initTimedBlockId = -1),
                    (E.methodMap = {}),
                    E);
            function E() {}
            d.GameAnalytics = n;
