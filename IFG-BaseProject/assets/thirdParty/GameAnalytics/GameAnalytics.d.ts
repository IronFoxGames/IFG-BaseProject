...
declare module gameanalytics {
    module state {
        class GAState {
            ...
            static validateAndCleanCustomFields(
                fields: {
                    [id: string]: any;
                },
            ...
            static addOnBeforeUnloadListener(listener: { onBeforeUnload: () => void }): void;
            static removeOnBeforeUnloadListener(listener: { onBeforeUnload: () => void }): void;
...
declare module gameanalytics {
    class GameAnalytics {
        ...
        static addAdEventWithNoAdReason(
            adAction?: EGAAdAction,
            adType?: EGAAdType,
            adSdkName?: string,
            adPlacement?: string,
        ...
        static setCustomDimension02(dimension?: string): void;
        static setCustomDimension03(dimension?: string): void;
        static setGlobalCustomEventFields(customFields?: { [id: string]: any }): void;
